...
public class Items
{
    ...
    private static Item getRegisteredItem(final String llllllllllllllIllllllIlIIIIllIII) {
        return (Item)Item.itemRegistry.getObject(new ResourceLocation(llllllllllllllIllllllIlIIIIllIII));
    }
}
