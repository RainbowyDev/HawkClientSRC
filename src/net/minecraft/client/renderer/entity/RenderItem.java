...
{
    public static /* synthetic */ float field_175051_f;
    public static /* synthetic */ float field_175062_i;
    private final /* synthetic */ ItemModelMesher itemModelMesher;
    public static /* synthetic */ float field_175054_e;
    private /* synthetic */ ModelResourceLocation modelLocation;
    public static /* synthetic */ float field_175061_h;
    public static /* synthetic */ float field_175060_j;
    private static final /* synthetic */ ResourceLocation RES_ITEM_GLINT;
    private /* synthetic */ boolean field_175058_l;
    public static /* synthetic */ float field_175052_g;
    public static /* synthetic */ float field_175053_d;
    private final /* synthetic */ TextureManager field_175057_n;
    public static /* synthetic */ float field_175056_c;
    public /* synthetic */ float zLevel;
    public static /* synthetic */ float field_175055_b;
    
    private void func_175038_a(final WorldRenderer llllllllllllllllllllllIllIlllIll, final BakedQuad llllllllllllllllllllllIllIllllIl) {
        final Vec3i llllllllllllllllllllllIllIllllII = llllllllllllllllllllllIllIllllIl.getFace().getDirectionVec();
        llllllllllllllllllllllIllIlllIll.func_178975_e((float)llllllllllllllllllllllIllIllllII.getX(), (float)llllllllllllllllllllllIllIllllII.getY(), (float)llllllllllllllllllllllIllIllllII.getZ());
    }
    
    public void func_175043_b(final ItemStack llllllllllllllllllllllIlIlllIlIl) {
        final IBakedModel llllllllllllllllllllllIlIlllIlII = this.itemModelMesher.getItemModel(llllllllllllllllllllllIlIlllIlIl);
        this.func_175040_a(llllllllllllllllllllllIlIlllIlIl, llllllllllllllllllllllIlIlllIlII, ItemCameraTransforms.TransformType.NONE);
    }
    
    private void func_175044_a(final WorldRenderer llllllllllllllllllllllIIllIlIIll, final int llllllllllllllllllllllIIllIlIIlI, final int llllllllllllllllllllllIIllIIlIll, final int llllllllllllllllllllllIIllIIlIlI, final int llllllllllllllllllllllIIllIIllll, final int llllllllllllllllllllllIIllIIlllI) {
        llllllllllllllllllllllIIllIlIIll.startDrawingQuads();
        llllllllllllllllllllllIIllIlIIll.func_178991_c(llllllllllllllllllllllIIllIIlllI);
        llllllllllllllllllllllIIllIlIIll.addVertex(llllllllllllllllllllllIIllIlIIlI + 0, llllllllllllllllllllllIIllIIlIll + 0, 0.0);
        llllllllllllllllllllllIIllIlIIll.addVertex(llllllllllllllllllllllIIllIlIIlI + 0, llllllllllllllllllllllIIllIIlIll + llllllllllllllllllllllIIllIIllll, 0.0);
        llllllllllllllllllllllIIllIlIIll.addVertex(llllllllllllllllllllllIIllIlIIlI + llllllllllllllllllllllIIllIIlIlI, llllllllllllllllllllllIIllIIlIll + llllllllllllllllllllllIIllIIllll, 0.0);
        llllllllllllllllllllllIIllIlIIll.addVertex(llllllllllllllllllllllIIllIlIIlI + llllllllllllllllllllllIIllIIlIlI, llllllllllllllllllllllIIllIIlIll + 0, 0.0);
        Tessellator.getInstance().draw();
    }
    
    public static void forgeHooksClient_putQuadColor(final WorldRenderer llllllllllllllllllllllIIlIIllIlI, final BakedQuad llllllllllllllllllllllIIlIlIllII, final int llllllllllllllllllllllIIlIIllIII) {
        final float llllllllllllllllllllllIIlIlIlIlI = (float)(llllllllllllllllllllllIIlIIllIII & 0xFF);
        final float llllllllllllllllllllllIIlIlIlIIl = (float)(llllllllllllllllllllllIIlIIllIII >>> 8 & 0xFF);
        final float llllllllllllllllllllllIIlIlIlIII = (float)(llllllllllllllllllllllIIlIIllIII >>> 16 & 0xFF);
        final float llllllllllllllllllllllIIlIlIIlll = (float)(llllllllllllllllllllllIIlIIllIII >>> 24 & 0xFF);
        final int[] llllllllllllllllllllllIIlIlIIllI = llllllllllllllllllllllIIlIlIllII.func_178209_a();
        final int llllllllllllllllllllllIIlIlIIlIl = llllllllllllllllllllllIIlIlIIllI.length / 4;
        for (int llllllllllllllllllllllIIlIlIIlII = 0; llllllllllllllllllllllIIlIlIIlII < 4; ++llllllllllllllllllllllIIlIlIIlII) {
            final int llllllllllllllllllllllIIlIlIIIll = llllllllllllllllllllllIIlIlIIllI[3 + llllllllllllllllllllllIIlIlIIlIl * llllllllllllllllllllllIIlIlIIlII];
            final float llllllllllllllllllllllIIlIlIIIlI = (float)(llllllllllllllllllllllIIlIlIIIll & 0xFF);
            final float llllllllllllllllllllllIIlIlIIIIl = (float)(llllllllllllllllllllllIIlIlIIIll >>> 8 & 0xFF);
            final float llllllllllllllllllllllIIlIlIIIII = (float)(llllllllllllllllllllllIIlIlIIIll >>> 16 & 0xFF);
            final float llllllllllllllllllllllIIlIIlllll = (float)(llllllllllllllllllllllIIlIlIIIll >>> 24 & 0xFF);
            final int llllllllllllllllllllllIIlIIllllI = Math.min(255, (int)(llllllllllllllllllllllIIlIlIlIlI * llllllllllllllllllllllIIlIlIIIlI / 255.0f));
            final int llllllllllllllllllllllIIlIIlllIl = Math.min(255, (int)(llllllllllllllllllllllIIlIlIlIIl * llllllllllllllllllllllIIlIlIIIIl / 255.0f));
            final int llllllllllllllllllllllIIlIIlllII = Math.min(255, (int)(llllllllllllllllllllllIIlIlIlIII * llllllllllllllllllllllIIlIlIIIII / 255.0f));
            final int llllllllllllllllllllllIIlIIllIll = Math.min(255, (int)(llllllllllllllllllllllIIlIlIIlll * llllllllllllllllllllllIIlIIlllll / 255.0f));
            llllllllllllllllllllllIIlIIllIlI.func_178972_a(llllllllllllllllllllllIIlIIllIlI.getGLCallListForPass(4 - llllllllllllllllllllllIIlIlIIlII), llllllllllllllllllllllIIlIIllllI, llllllllllllllllllllllIIlIIlllIl, llllllllllllllllllllllIIlIIlllII, llllllllllllllllllllllIIlIIllIll);
        }
    }
    
    protected void func_175034_a(final ItemTransformVec3f llllllllllllllllllllllIlIlIlIIlI) {
        applyVanillaTransform(llllllllllllllllllllllIlIlIlIIlI);
    }
    
    private void registerBlock(final Block lllllllllllllllllllllllIIIIllIII, final String lllllllllllllllllllllllIIIIlIlll) {
        this.registerBlock(lllllllllllllllllllllllIIIIllIII, 0, lllllllllllllllllllllllIIIIlIlll);
    }
    ...
    protected void registerBlock(final Block lllllllllllllllllllllllIIIlIIllI, final int lllllllllllllllllllllllIIIlIIIIl, final String lllllllllllllllllllllllIIIlIIIII) {
        this.registerItem(Item.getItemFromBlock(lllllllllllllllllllllllIIIlIIllI), lllllllllllllllllllllllIIIlIIIIl, lllllllllllllllllllllllIIIlIIIII);
    }
    
    public void func_180454_a(final ItemStack llllllllllllllllllllllIlllIlIIll, IBakedModel llllllllllllllllllllllIlllIIllll) {
        GlStateManager.pushMatrix();
        GlStateManager.scale(0.5f, 0.5f, 0.5f);
        if (((IBakedModel)llllllllllllllllllllllIlllIIllll).isBuiltInRenderer()) {
            GlStateManager.rotate(180.0f, 0.0f, 1.0f, 0.0f);
            GlStateManager.translate(-0.5f, -0.5f, -0.5f);
            GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
            GlStateManager.enableRescaleNormal();
            TileEntityRendererChestHelper.instance.renderByItem(llllllllllllllllllllllIlllIlIIll);
        }
        else {
            if (Config.isCustomItems()) {
                llllllllllllllllllllllIlllIIllll = CustomItems.getCustomItemModel(llllllllllllllllllllllIlllIlIIll, (IBakedModel)llllllllllllllllllllllIlllIIllll, this.modelLocation);
            }
            GlStateManager.translate(-0.5f, -0.5f, -0.5f);
            this.func_175036_a((IBakedModel)llllllllllllllllllllllIlllIIllll, llllllllllllllllllllllIlllIlIIll);
            if (llllllllllllllllllllllIlllIlIIll.hasEffect() && (!Config.isCustomItems() || !CustomItems.renderCustomEffect(this, llllllllllllllllllllllIlllIlIIll, (IBakedModel)llllllllllllllllllllllIlllIIllll))) {
                this.renderEffect((IBakedModel)llllllllllllllllllllllIlllIIllll);
            }
        }
        GlStateManager.popMatrix();
    }
    
    private void func_175033_a(final WorldRenderer llllllllllllllllllllllIllIlIllll, final BakedQuad llllllllllllllllllllllIllIllIIlI, final int llllllllllllllllllllllIllIlIllIl) {
        if (llllllllllllllllllllllIllIlIllll.isMultiTexture()) {
            llllllllllllllllllllllIllIlIllll.func_178981_a(llllllllllllllllllllllIllIllIIlI.getVertexDataSingle());
            llllllllllllllllllllllIllIlIllll.putSprite(llllllllllllllllllllllIllIllIIlI.getSprite());
        }
        else {
            llllllllllllllllllllllIllIlIllll.func_178981_a(llllllllllllllllllllllIllIllIIlI.func_178209_a());
        }
        if (Reflector.IColoredBakedQuad.exists() && Reflector.IColoredBakedQuad.isInstance(llllllllllllllllllllllIllIllIIlI)) {
            forgeHooksClient_putQuadColor(llllllllllllllllllllllIllIlIllll, llllllllllllllllllllllIllIllIIlI, llllllllllllllllllllllIllIlIllIl);
        }
        else {
            llllllllllllllllllllllIllIlIllll.func_178968_d(llllllllllllllllllllllIllIlIllIl);
        }
        this.func_175038_a(llllllllllllllllllllllIllIlIllll, llllllllllllllllllllllIllIllIIlI);
    }
    
    public void func_180453_a(final FontRenderer llllllllllllllllllllllIIllllIlIl, final ItemStack llllllllllllllllllllllIIlllIIlIl, final int llllllllllllllllllllllIIlllIIlII, final int llllllllllllllllllllllIIlllIIIll, final String llllllllllllllllllllllIIllllIIIl) {
        if (llllllllllllllllllllllIIlllIIlIl != null) {
            if (llllllllllllllllllllllIIlllIIlIl.stackSize != 1 || llllllllllllllllllllllIIllllIIIl != null) {
                String llllllllllllllllllllllIIllllIIII = (llllllllllllllllllllllIIllllIIIl == null) ? String.valueOf(llllllllllllllllllllllIIlllIIlIl.stackSize) : llllllllllllllllllllllIIllllIIIl;
                if (llllllllllllllllllllllIIllllIIIl == null && llllllllllllllllllllllIIlllIIlIl.stackSize < 1) {
                    llllllllllllllllllllllIIllllIIII = String.valueOf(new StringBuilder().append(EnumChatFormatting.RED).append(String.valueOf(llllllllllllllllllllllIIlllIIlIl.stackSize)));
                }
                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
                GlStateManager.disableBlend();
                llllllllllllllllllllllIIllllIlIl.drawStringWithShadow(llllllllllllllllllllllIIllllIIII, (float)(llllllllllllllllllllllIIlllIIlII + 19 - 2 - llllllllllllllllllllllIIllllIlIl.getStringWidth(llllllllllllllllllllllIIllllIIII)), (float)(llllllllllllllllllllllIIlllIIIll + 6 + 3), 16777215);
                GlStateManager.enableLighting();
                GlStateManager.enableDepth();
            }
            boolean llllllllllllllllllllllIIlllIllll = llllllllllllllllllllllIIlllIIlIl.isItemDamaged();
            if (Reflector.ForgeItem_showDurabilityBar.exists()) {
                llllllllllllllllllllllIIlllIllll = Reflector.callBoolean(llllllllllllllllllllllIIlllIIlIl.getItem(), Reflector.ForgeItem_showDurabilityBar, llllllllllllllllllllllIIlllIIlIl);
            }
            if (llllllllllllllllllllllIIlllIllll) {
                int llllllllllllllllllllllIIlllIlllI = (int)Math.round(13.0 - llllllllllllllllllllllIIlllIIlIl.getItemDamage() * 13.0 / llllllllllllllllllllllIIlllIIlIl.getMaxDamage());
                int llllllllllllllllllllllIIlllIllIl = (int)Math.round(255.0 - llllllllllllllllllllllIIlllIIlIl.getItemDamage() * 255.0 / llllllllllllllllllllllIIlllIIlIl.getMaxDamage());
                if (Reflector.ForgeItem_getDurabilityForDisplay.exists()) {
                    final double llllllllllllllllllllllIIlllIllII = Reflector.callDouble(llllllllllllllllllllllIIlllIIlIl.getItem(), Reflector.ForgeItem_getDurabilityForDisplay, llllllllllllllllllllllIIlllIIlIl);
                    llllllllllllllllllllllIIlllIlllI = (int)Math.round(13.0 - llllllllllllllllllllllIIlllIllII * 13.0);
                    llllllllllllllllllllllIIlllIllIl = (int)Math.round(255.0 - llllllllllllllllllllllIIlllIllII * 255.0);
                }
                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
                ...
                GlStateManager.disableBlend();
                final Tessellator llllllllllllllllllllllIIlllIlIll = Tessellator.getInstance();
                final WorldRenderer llllllllllllllllllllllIIlllIlIlI = llllllllllllllllllllllIIlllIlIll.getWorldRenderer();
                final int llllllllllllllllllllllIIlllIlIIl = 255 - llllllllllllllllllllllIIlllIllIl << 16 | llllllllllllllllllllllIIlllIllIl << 8;
                final int llllllllllllllllllllllIIlllIlIII = (255 - llllllllllllllllllllllIIlllIllIl) / 4 << 16 | 0x3F00;
                this.func_175044_a(llllllllllllllllllllllIIlllIlIlI, llllllllllllllllllllllIIlllIIlII + 2, llllllllllllllllllllllIIlllIIIll + 13, 13, 2, 0);
                this.func_175044_a(llllllllllllllllllllllIIlllIlIlI, llllllllllllllllllllllIIlllIIlII + 2, llllllllllllllllllllllIIlllIIIll + 13, 12, 1, llllllllllllllllllllllIIlllIlIII);
                this.func_175044_a(llllllllllllllllllllllIIlllIlIlI, llllllllllllllllllllllIIlllIIlII + 2, llllllllllllllllllllllIIlllIIIll + 13, llllllllllllllllllllllIIlllIlllI, 1, llllllllllllllllllllllIIlllIlIIl);
    ...
    public void func_175030_a(final FontRenderer llllllllllllllllllllllIlIIIIllII, final ItemStack llllllllllllllllllllllIlIIIIlIll, final int llllllllllllllllllllllIlIIIIlIlI, final int llllllllllllllllllllllIlIIIIIlII) {
        this.func_180453_a(llllllllllllllllllllllIlIIIIllII, llllllllllllllllllllllIlIIIIlIll, llllllllllllllllllllllIlIIIIlIlI, llllllllllllllllllllllIlIIIIIlII, null);
    }
    
    protected void func_175040_a(final ItemStack llllllllllllllllllllllIlIlIIIlIl, IBakedModel llllllllllllllllllllllIlIlIIIlII, final ItemCameraTransforms.TransformType llllllllllllllllllllllIlIlIIIlll) {
        ...
        this.func_175046_c(llllllllllllllllllllllIlIlIIIlIl);
        GlStateManager.enableRescaleNormal();
        ...
        if (Reflector.ForgeHooksClient_handleCameraTransforms.exists()) {
            llllllllllllllllllllllIlIlIIIlII = (IBakedModel)Reflector.call(Reflector.ForgeHooksClient_handleCameraTransforms, llllllllllllllllllllllIlIlIIIlII, llllllllllllllllllllllIlIlIIIlll);
        }
        else {
            switch (SwitchTransformType.field_178640_a[llllllllllllllllllllllIlIlIIIlll.ordinal()]) {
                case 2: {
                    this.func_175034_a(llllllllllllllllllllllIlIlIIIlII.getItemCameraTransforms().field_178355_b);
                    break;
                }
                case 3: {
                    this.func_175034_a(llllllllllllllllllllllIlIlIIIlII.getItemCameraTransforms().field_178356_c);
                    break;
                }
                case 4: {
                    this.func_175034_a(llllllllllllllllllllllIlIlIIIlII.getItemCameraTransforms().field_178353_d);
                    break;
                }
                case 5: {
                    this.func_175034_a(llllllllllllllllllllllIlIlIIIlII.getItemCameraTransforms().field_178354_e);
                    break;
                }
            }
        }
        this.func_180454_a(llllllllllllllllllllllIlIlIIIlIl, llllllllllllllllllllllIlIlIIIlII);
        GlStateManager.popMatrix();
    ...
    private void registerItem(final Item lllllllllllllllllllllllIIIIIllll, final String lllllllllllllllllllllllIIIIIlllI) {
        this.registerItem(lllllllllllllllllllllllIIIIIllll, 0, lllllllllllllllllllllllIIIIIlllI);
    }
    
    private void func_175036_a(final IBakedModel lllllllllllllllllllllllIIIIIIllI, final ItemStack lllllllllllllllllllllllIIIIIlIII) {
        this.func_175045_a(lllllllllllllllllllllllIIIIIIllI, -1, lllllllllllllllllllllllIIIIIlIII);
    }
    
    public void func_175035_a(final IBakedModel lllllllllllllllllllllllIIIIIIIII, final int llllllllllllllllllllllIlllllllll) {
        this.func_175045_a(lllllllllllllllllllllllIIIIIIIII, llllllllllllllllllllllIlllllllll, null);
    }
    
    public RenderItem(final TextureManager lllllllllllllllllllllllIIlIIIIlI, final ModelManager lllllllllllllllllllllllIIlIIIIIl) {
        this.field_175058_l = true;
        this.modelLocation = null;
        this.field_175057_n = lllllllllllllllllllllllIIlIIIIlI;
        Config.setModelManager(lllllllllllllllllllllllIIlIIIIIl);
        if (Reflector.ItemModelMesherForge_Constructor.exists()) {
            this.itemModelMesher = (ItemModelMesher)Reflector.newInstance(Reflector.ItemModelMesherForge_Constructor, lllllllllllllllllllllllIIlIIIIIl);
        }
        else {
            this.itemModelMesher = new ItemModelMesher(lllllllllllllllllllllllIIlIIIIIl);
        }
        this.registerItems();
    }
    
    public void func_175042_a(final ItemStack llllllllllllllllllllllIlIIllIlll, final int llllllllllllllllllllllIlIIlllIll, final int llllllllllllllllllllllIlIIllIlIl) {
        IBakedModel llllllllllllllllllllllIlIIlllIIl = this.itemModelMesher.getItemModel(llllllllllllllllllllllIlIIllIlll);
        GlStateManager.pushMatrix();
        this.field_175057_n.bindTexture(TextureMap.locationBlocksTexture);
        this.field_175057_n.getTexture(TextureMap.locationBlocksTexture).func_174936_b(false, false);
        GlStateManager.enableRescaleNormal();
        ...
        GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
        this.func_180452_a(llllllllllllllllllllllIlIIlllIll, llllllllllllllllllllllIlIIllIlIl, llllllllllllllllllllllIlIIlllIIl.isAmbientOcclusionEnabled());
        if (Reflector.ForgeHooksClient_handleCameraTransforms.exists()) {
            llllllllllllllllllllllIlIIlllIIl = (IBakedModel)Reflector.call(Reflector.ForgeHooksClient_handleCameraTransforms, llllllllllllllllllllllIlIIlllIIl, ItemCameraTransforms.TransformType.GUI);
        }
        else {
            this.func_175034_a(llllllllllllllllllllllIlIIlllIIl.getItemCameraTransforms().field_178354_e);
        }
        this.func_180454_a(llllllllllllllllllllllIlIIllIlll, llllllllllllllllllllllIlIIlllIIl);
        GlStateManager.disableAlpha();
        GlStateManager.disableRescaleNormal();
        GlStateManager.disableLighting();
        GlStateManager.popMatrix();
    ...
    private void func_180452_a(final int llllllllllllllllllllllIlIIlIlIlI, final int llllllllllllllllllllllIlIIlIlIIl, final boolean llllllllllllllllllllllIlIIlIllII) {
        GlStateManager.translate((float)llllllllllllllllllllllIlIIlIlIlI, (float)llllllllllllllllllllllIlIIlIlIIl, 100.0f + this.zLevel);
        GlStateManager.translate(8.0f, 8.0f, 0.0f);
        GlStateManager.scale(1.0f, 1.0f, -1.0f);
        GlStateManager.scale(0.5f, 0.5f, 0.5f);
        if (llllllllllllllllllllllIlIIlIllII) {
    ...
    private void renderEffect(final IBakedModel llllllllllllllllllllllIlllIIlIIl) {
        if (!Config.isCustomItems() || CustomItems.isUseGlint()) {
            ...
            final float llllllllllllllllllllllIlllIIlIII = Minecraft.getSystemTime() % 3000L / 3000.0f / 8.0f;
            GlStateManager.translate(llllllllllllllllllllllIlllIIlIII, 0.0f, 0.0f);
            GlStateManager.rotate(-50.0f, 0.0f, 0.0f, 1.0f);
            this.func_175035_a(llllllllllllllllllllllIlllIIlIIl, -8372020);
            GlStateManager.popMatrix();
            GlStateManager.pushMatrix();
            GlStateManager.scale(8.0f, 8.0f, 8.0f);
            final float llllllllllllllllllllllIlllIIIlll = Minecraft.getSystemTime() % 4873L / 4873.0f / 8.0f;
            GlStateManager.translate(-llllllllllllllllllllllIlllIIIlll, 0.0f, 0.0f);
    ...
    private void func_175046_c(final ItemStack llllllllllllllllllllllIllIIIIIlI) {
        final IBakedModel llllllllllllllllllllllIllIIIIIIl = this.itemModelMesher.getItemModel(llllllllllllllllllllllIllIIIIIlI);
        final Item llllllllllllllllllllllIllIIIIIII = llllllllllllllllllllllIllIIIIIlI.getItem();
        if (llllllllllllllllllllllIllIIIIIII != null) {
            final boolean llllllllllllllllllllllIlIlllllll = llllllllllllllllllllllIllIIIIIIl.isAmbientOcclusionEnabled();
            if (!llllllllllllllllllllllIlIlllllll) {
    ...
    private void registerItems() {
        ...
        this.itemModelMesher.register(Items.potionitem, new ItemMeshDefinition() {
            ...
            @Override
            public ModelResourceLocation getModelLocation(final ItemStack llllllllllllllIlllIIIIlIllIIlIlI) {
                return ItemPotion.isSplash(llllllllllllllIlllIIIIlIllIIlIlI.getMetadata()) ? new ModelResourceLocation("bottle_splash", "inventory") : new ModelResourceLocation("bottle_drinkable", "inventory");
            }
        });
        ...
        this.itemModelMesher.register(Items.spawn_egg, new ItemMeshDefinition() {
            @Override
            public ModelResourceLocation getModelLocation(final ItemStack llllllllllllllllllllIIIIlIIlIIII) {
        ...
        this.itemModelMesher.register(Items.banner, new ItemMeshDefinition() {
            @Override
            public ModelResourceLocation getModelLocation(final ItemStack llllllllllllllIllIlIIllIlIIlIllI) {
        ...
        this.itemModelMesher.register(Items.enchanted_book, new ItemMeshDefinition() {
            ...
            @Override
            public ModelResourceLocation getModelLocation(final ItemStack llllllllllllllllIlIIIIlIIlIIIlII) {
        ...
        this.itemModelMesher.register(Items.filled_map, new ItemMeshDefinition() {
            ...
            @Override
            public ModelResourceLocation getModelLocation(final ItemStack llllllllllllllllIIIIIIllIIlIIIII) {
    ...
    protected void registerItem(final Item lllllllllllllllllllllllIIIllIIlI, final int lllllllllllllllllllllllIIIllIIIl, final String lllllllllllllllllllllllIIIlIllII) {
        this.itemModelMesher.register(lllllllllllllllllllllllIIIllIIlI, lllllllllllllllllllllllIIIllIIIl, new ModelResourceLocation(lllllllllllllllllllllllIIIlIllII, "inventory"));
    }
    
    @Override
    public void onResourceManagerReload(final IResourceManager llllllllllllllllllllllIIllIIIIlI) {
        this.itemModelMesher.rebuildCache();
    }
    
    public boolean func_175050_a(final ItemStack llllllllllllllllllllllIllIIIllIl) {
        final IBakedModel llllllllllllllllllllllIllIIIllII = this.itemModelMesher.getItemModel(llllllllllllllllllllllIllIIIllIl);
        return llllllllllllllllllllllIllIIIllII != null && llllllllllllllllllllllIllIIIllII.isAmbientOcclusionEnabled();
    }
    
    private void func_175032_a(final WorldRenderer llllllllllllllllllllllIllIIllIIl, final List llllllllllllllllllllllIllIIllIII, final int llllllllllllllllllllllIllIIlIlll, final ItemStack llllllllllllllllllllllIllIIlIllI) {
        final boolean llllllllllllllllllllllIllIIllllI = llllllllllllllllllllllIllIIlIlll == -1 && llllllllllllllllllllllIllIIlIllI != null;
        for (final BakedQuad llllllllllllllllllllllIllIIlllIl : llllllllllllllllllllllIllIIllIII) {
            int llllllllllllllllllllllIllIIlllII = llllllllllllllllllllllIllIIlIlll;
            if (llllllllllllllllllllllIllIIllllI && llllllllllllllllllllllIllIIlllIl.func_178212_b()) {
                llllllllllllllllllllllIllIIlllII = llllllllllllllllllllllIllIIlIllI.getItem().getColorFromItemStack(llllllllllllllllllllllIllIIlIllI, llllllllllllllllllllllIllIIlllIl.func_178211_c());
                if (Config.isCustomColors()) {
                    llllllllllllllllllllllIllIIlllII = CustomColors.getColorFromItemStack(llllllllllllllllllllllIllIIlIllI, llllllllllllllllllllllIllIIlllIl.func_178211_c(), llllllllllllllllllllllIllIIlllII);
                }
                if (EntityRenderer.anaglyphEnable) {
                    llllllllllllllllllllllIllIIlllII = TextureUtil.func_177054_c(llllllllllllllllllllllIllIIlllII);
                }
                llllllllllllllllllllllIllIIlllII |= 0xFF000000;
            }
            this.func_175033_a(llllllllllllllllllllllIllIIllIIl, llllllllllllllllllllllIllIIlllIl, llllllllllllllllllllllIllIIlllII);
        }
    }
    
    public static void applyVanillaTransform(final ItemTransformVec3f llllllllllllllllllllllIlIlIIllll) {
        if (llllllllllllllllllllllIlIlIIllll != ItemTransformVec3f.field_178366_a) {
            GlStateManager.translate(llllllllllllllllllllllIlIlIIllll.field_178365_c.x + RenderItem.field_175055_b, llllllllllllllllllllllIlIlIIllll.field_178365_c.y + RenderItem.field_175056_c, llllllllllllllllllllllIlIlIIllll.field_178365_c.z + RenderItem.field_175053_d);
            GlStateManager.rotate(llllllllllllllllllllllIlIlIIllll.field_178364_b.y + RenderItem.field_175051_f, 0.0f, 1.0f, 0.0f);
            GlStateManager.rotate(llllllllllllllllllllllIlIlIIllll.field_178364_b.x + RenderItem.field_175054_e, 1.0f, 0.0f, 0.0f);
            GlStateManager.rotate(llllllllllllllllllllllIlIlIIllll.field_178364_b.z + RenderItem.field_175052_g, 0.0f, 0.0f, 1.0f);
            GlStateManager.scale(llllllllllllllllllllllIlIlIIllll.field_178363_d.x + RenderItem.field_175061_h, llllllllllllllllllllllIlIlIIllll.field_178363_d.y + RenderItem.field_175062_i, llllllllllllllllllllllIlIlIIllll.field_178363_d.z + RenderItem.field_175060_j);
        }
    }
    
    public void func_175049_a(final ItemStack llllllllllllllllllllllIlIllIIllI, final EntityLivingBase llllllllllllllllllllllIlIlIlllII, final ItemCameraTransforms.TransformType llllllllllllllllllllllIlIllIIlII) {
        IBakedModel llllllllllllllllllllllIlIllIIIll = this.itemModelMesher.getItemModel(llllllllllllllllllllllIlIllIIllI);
        if (llllllllllllllllllllllIlIlIlllII instanceof EntityPlayer) {
            final EntityPlayer llllllllllllllllllllllIlIllIIIlI = (EntityPlayer)llllllllllllllllllllllIlIlIlllII;
            final Item llllllllllllllllllllllIlIllIIIIl = llllllllllllllllllllllIlIllIIllI.getItem();
            ModelResourceLocation llllllllllllllllllllllIlIllIIIII = null;
            if (llllllllllllllllllllllIlIllIIIIl == Items.fishing_rod && llllllllllllllllllllllIlIllIIIlI.fishEntity != null) {
                llllllllllllllllllllllIlIllIIIII = new ModelResourceLocation("fishing_rod_cast", "inventory");
            }
            else if (llllllllllllllllllllllIlIllIIIIl == Items.bow && llllllllllllllllllllllIlIllIIIlI.getItemInUse() != null) {
                final int llllllllllllllllllllllIlIlIlllll = llllllllllllllllllllllIlIllIIllI.getMaxItemUseDuration() - llllllllllllllllllllllIlIllIIIlI.getItemInUseCount();
                if (llllllllllllllllllllllIlIlIlllll >= 18) {
                    llllllllllllllllllllllIlIllIIIII = new ModelResourceLocation("bow_pulling_2", "inventory");
                }
                else if (llllllllllllllllllllllIlIlIlllll > 13) {
                    llllllllllllllllllllllIlIllIIIII = new ModelResourceLocation("bow_pulling_1", "inventory");
                }
                else if (llllllllllllllllllllllIlIlIlllll > 0) {
                    llllllllllllllllllllllIlIllIIIII = new ModelResourceLocation("bow_pulling_0", "inventory");
                }
            }
            else if (Reflector.ForgeItem_getModel.exists()) {
                llllllllllllllllllllllIlIllIIIII = (ModelResourceLocation)Reflector.call(llllllllllllllllllllllIlIllIIIIl, Reflector.ForgeItem_getModel, llllllllllllllllllllllIlIllIIllI, llllllllllllllllllllllIlIllIIIlI, llllllllllllllllllllllIlIllIIIlI.getItemInUseCount());
            }
            if ((this.modelLocation = llllllllllllllllllllllIlIllIIIII) != null) {
                llllllllllllllllllllllIlIllIIIll = this.itemModelMesher.getModelManager().getModel(llllllllllllllllllllllIlIllIIIII);
            }
        }
        this.func_175040_a(llllllllllllllllllllllIlIllIIllI, llllllllllllllllllllllIlIllIIIll, llllllllllllllllllllllIlIllIIlII);
        this.modelLocation = null;
    }
    
    public void func_180450_b(final ItemStack llllllllllllllllllllllIlIIIlllll, final int llllllllllllllllllllllIlIIIllllI, final int llllllllllllllllllllllIlIIIlIllI) {
        if (llllllllllllllllllllllIlIIIlllll != null) {
            this.zLevel += 50.0f;
            try {
                this.func_175042_a(llllllllllllllllllllllIlIIIlllll, llllllllllllllllllllllIlIIIllllI, llllllllllllllllllllllIlIIIlIllI);
            }
            catch (Throwable llllllllllllllllllllllIlIIIlllII) {
                final CrashReport llllllllllllllllllllllIlIIIllIll = CrashReport.makeCrashReport(llllllllllllllllllllllIlIIIlllII, "Rendering item");
                final CrashReportCategory llllllllllllllllllllllIlIIIllIlI = llllllllllllllllllllllIlIIIllIll.makeCategory("Item being rendered");
                llllllllllllllllllllllIlIIIllIlI.addCrashSectionCallable("Item Type", new Callable() {
                    static {
                        __OBFID = "CL_00001004";
                    }
                    ...
                    @Override
                    public String call() {
                        return String.valueOf(llllllllllllllllllllllIlIIIlllll.getItem());
                    }
                });
                llllllllllllllllllllllIlIIIllIlI.addCrashSectionCallable("Item Aux", new Callable() {
                    @Override
                    public String call() {
                        return String.valueOf(llllllllllllllllllllllIlIIIlllll.getMetadata());
                    }
                ...
                llllllllllllllllllllllIlIIIllIlI.addCrashSectionCallable("Item NBT", new Callable() {
                    static {
                        __OBFID = "CL_00001006";
                    }
                    ...
                    @Override
                    public String call() {
                        return String.valueOf(llllllllllllllllllllllIlIIIlllll.getTagCompound());
                    }
                });
                llllllllllllllllllllllIlIIIllIlI.addCrashSectionCallable("Item Foil", new Callable() {
                    @Override
                    public String call() {
                        return String.valueOf(llllllllllllllllllllllIlIIIlllll.hasEffect());
                    }
                });
                throw new ReportedException(llllllllllllllllllllllIlIIIllIll);
            }
            this.zLevel -= 50.0f;
        }
    }
    
    private void func_175045_a(final IBakedModel llllllllllllllllllllllIllllIIIlI, final int llllllllllllllllllllllIllllIIIIl, final ItemStack llllllllllllllllllllllIllllIIIII) {
        final Tessellator llllllllllllllllllllllIllllIlIll = Tessellator.getInstance();
        final WorldRenderer llllllllllllllllllllllIllllIlIlI = llllllllllllllllllllllIllllIlIll.getWorldRenderer();
        final boolean llllllllllllllllllllllIllllIlIIl = Minecraft.getMinecraft().getTextureMapBlocks().isTextureBound();
        final boolean llllllllllllllllllllllIllllIlIII = Config.isMultiTexture() && llllllllllllllllllllllIllllIlIIl;
        if (llllllllllllllllllllllIllllIlIII) {
            llllllllllllllllllllllIllllIlIlI.setBlockLayer(EnumWorldBlockLayer.SOLID);
        }
        llllllllllllllllllllllIllllIlIlI.startDrawingQuads();
        llllllllllllllllllllllIllllIlIlI.setVertexFormat(DefaultVertexFormats.field_176599_b);
        for (final EnumFacing llllllllllllllllllllllIllllIIlII : EnumFacing.VALUES) {
            this.func_175032_a(llllllllllllllllllllllIllllIlIlI, llllllllllllllllllllllIllllIIIlI.func_177551_a(llllllllllllllllllllllIllllIIlII), llllllllllllllllllllllIllllIIIIl, llllllllllllllllllllllIllllIIIII);
        }
        this.func_175032_a(llllllllllllllllllllllIllllIlIlI, llllllllllllllllllllllIllllIIIlI.func_177550_a(), llllllllllllllllllllllIllllIIIIl, llllllllllllllllllllllIllllIIIII);
        llllllllllllllllllllllIllllIlIll.draw();
        if (llllllllllllllllllllllIllllIlIII) {
            llllllllllllllllllllllIllllIlIlI.setBlockLayer(null);
            GlStateManager.bindCurrentTexture();
        }
    }
    
    public void func_175039_a(final boolean lllllllllllllllllllllllIIIllllIl) {
        this.field_175058_l = lllllllllllllllllllllllIIIllllIl;
    }
    
    static final class SwitchTransformType
    {
        static final /* synthetic */ int[] field_178640_a;
